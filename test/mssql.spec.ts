...
describe('mssql', () => {
  ...
  describe('.tables', () => {
    it('returns tables', async () => {
      expect((await inspector.tables()).sort(deepSort)).to.deep.equal(
        ['teams', 'users', 'page_visits'].sort(deepSort)
      );
    });
  });
  ...
  describe('.tableInfo', () => {
    it('returns information for all tables', async () => {
      expect((await inspector.tableInfo()).sort(deepSort)).to.deep.equal(
        [
          {
            name: 'teams',
            schema: 'dbo',
  ...
  describe('.columnInfo', () => {
    it('returns information for all columns in all tables', async () => {
      expect((await inspector.columnInfo()).sort(deepSort)).to.deep.equal(
        [
          {
            name: 'id',
            table: 'teams',
    ...
    it('returns information for all columns in specific table', async () => {
      expect(
        (await inspector.columnInfo('teams')).sort(deepSort)
      ).to.deep.equal(
        [
          {
            name: 'id',
  ...
  describe('.foreignKeys', () => {
    it('returns foreign keys for all tables', async () => {
      expect((await inspector.foreignKeys()).sort(deepSort)).to.deep.equal(
        [
          {
            table: 'users',
            column: 'team_id',
