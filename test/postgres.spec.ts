    ...
    it('returns information for all tables', async () => {
      database.transaction(async (trx) => {
        expect(await schemaInspector(trx).columns()).to.have.deep.members([
          ...
          { table: 'multiple_defaults', column: 'a3' },
          { table: 'multiple_defaults', column: 'a4' },
        ]);
      });
    ...
    it('returns information for all columns in all tables', async () => {
      expect(await inspector.columnInfo()).to.have.deep.members([
        ...
        },
        {
          ...
          table: 'multiple_defaults',
          data_type: 'ARRAY',
          default_value_raw: `ARRAY['{"text":"Lorem Ipsum"}'::json, '{"text":"dolor sit amet"}'::json]`,
          default_value: [{ text: 'Lorem Ipsum' }, { text: 'dolor sit amet' }],
          generation_expression: null,
          max_length: null,
          numeric_precision: null,
          numeric_scale: null,
        ...
        },
        {
          ...
          table: 'multiple_defaults',
          data_type: 'ARRAY',
          default_value_raw: `ARRAY['{"text": "Lorem Ipsum"}'::jsonb, '{"text": "dolor sit amet"}'::jsonb]`,
          default_value: [{ text: 'Lorem Ipsum' }, { text: 'dolor sit amet' }],
          generation_expression: null,
          max_length: null,
          numeric_precision: null,
